...
export default function CookieConsentBanner() {
  ...
  return (
    <div
      className="z-30 border-t border-border/50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60"
    >
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-wrap gap-2 shrink-0">
              <button
                type="button"
                onClick={rejectAll}
                className="rounded-xl border border-border bg-surface/90 px-4 py-2 text-sm font-medium text-foreground hover:bg-muted transition-colors"
              >
                Reject All
              </button>
              <button
