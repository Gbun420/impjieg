...
export function buildBiasCheckDeps(): BiasCheckDeps {
  return {
    getUser: async () => {
...
export async function biasCheckWithDeps(request: Request, deps: BiasCheckDeps) {
  try {
