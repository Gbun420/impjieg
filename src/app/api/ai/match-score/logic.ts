...
export function buildMatchScoreDeps(): MatchScoreDeps {
  return {
    getUser: async () => {
...
export async function matchScoreWithDeps(request: Request, deps: MatchScoreDeps) {
  try {
