...
export const MAX_PARSE_RESUME_BODY_BYTES = 32_768;
...
export function buildParseResumeDeps(): ParseResumeDeps {
  return {
    getUser: async () => {
...
export async function parseResumeWithDeps(request: Request, deps: ParseResumeDeps) {
  try {
