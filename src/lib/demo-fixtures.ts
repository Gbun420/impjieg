...
export const DEMO_USERS: DemoUserSeed[] = [
  {
    ...
    email: "careers@azurecrestgaming.test",
  ...
  },
  {
    ...
    email: "jobs@harborgridlabs.test",
    password: DEMO_SEED_PASSWORD,
    accountType: "employer",
  ...
  },
  {
    ...
    email: "talent@northlinecapital.test",
    password: DEMO_SEED_PASSWORD,
    accountType: "employer",
  ...
  },
  {
    ...
    email: "hiring@sunstonehealth.test",
    password: DEMO_SEED_PASSWORD,
    accountType: "employer",
  ...
  },
  {
    ...
    email: "opportunities@bluefinmedia.test",
    password: DEMO_SEED_PASSWORD,
    accountType: "employer",
  ...
  },
  {
    ...
    email: "hiring@terramotionlogistics.test",
    password: DEMO_SEED_PASSWORD,
    accountType: "employer",
...
export const DEMO_EMPLOYERS: DemoEmployerSeed[] = [
  {
    ...
    name: "Azure Crest Gaming",
    slug: "azure-crest-gaming",
    description:
      "A Malta-based iGaming product studio building sportsbook, casino, and payments experiences for regulated markets across Europe.",
    website: "https://azurecrestgaming.example",
    ...
    industry: "iGaming",
    cultureSummary:
      "Small, senior team with strong delivery habits, high autonomy, and weekly product reviews.",
    hiringProcess:
      "Two-stage interview process with a technical screen and a practical culture-fit conversation.",
    workplaceHighlights: [
      "Hybrid by default",
      "Quarterly team offsites in Malta",
  ...
  },
  {
    ...
    name: "HarborGrid Labs",
    slug: "harborgrid-labs",
    description:
      "A product engineering team focused on internal tools, SaaS dashboards, and workflow automation for modern growth companies.",
    website: "https://harborgridlabs.example",
    ...
    industry: "Technology",
    cultureSummary:
      "Design-aware engineering culture with low process overhead and a strong emphasis on shipping iteratively.",
    hiringProcess:
      "Portfolio review, short pairing session, and a final conversation with engineering leadership.",
    workplaceHighlights: [
      "Remote-friendly",
  ...
  },
  {
    ...
    description:
      "A regulated financial services operator modernising onboarding, reporting, and risk systems for cross-border client operations.",
    website: "https://northlinecapital.example",
    ...
    cultureSummary:
      "Structured, compliance-led environment with clear career paths and strong stakeholder visibility.",
    hiringProcess:
      "Recruiter screen, manager interview, and a final case study presentation.",
    workplaceHighlights: [
      "Career progression framework",
      "Hybrid schedules",
      "Heavy data ownership",
    ],
    responseTimeDays: 3,
    isVerified: false,
    emailNotifications: true,
  ...
  },
  {
    ...
    slug: "sunstone-health",
    description:
      "A healthcare operations platform helping clinics manage scheduling, patient communications, and back-office workflows.",
    website: "https://sunstonehealth.example",
    ...
    industry: "Healthcare",
    cultureSummary:
      "Mission-driven product team with calm delivery rhythms and frequent collaboration with clinicians.",
    hiringProcess:
      "Application review, hiring manager interview, and a short practical exercise.",
    workplaceHighlights: [
  ...
  },
  {
    ...
    slug: "bluefin-media",
    description:
      "A growth marketing studio building brand, content, and lifecycle systems for SaaS and consumer products.",
    website: "https://bluefinmedia.example",
    ...
    cultureSummary:
      "Small, creative team with a fast feedback loop and close contact with founders.",
    hiringProcess:
      "Creative brief, role-specific interview, and a short portfolio discussion.",
    workplaceHighlights: [
      "High-ownership projects",
      "Content and campaign exposure",
      "Hybrid flexibility",
    ],
    responseTimeDays: 2,
    isVerified: false,
  ...
  },
  {
    ...
    name: "Terra Motion Logistics",
    slug: "terra-motion-logistics",
    description:
      "A logistics technology operator focused on routing, fleet visibility, and customer service automation.",
    website: "https://terramotionlogistics.example",
    ...
    cultureSummary:
      "Practical, operations-first team that values reliability, clear hand-offs, and visible results.",
    hiringProcess:
      "Manager interview, functional interview, and a final team fit discussion.",
    workplaceHighlights: [
      "Operational improvement focus",
      "Room to modernise workflows",
