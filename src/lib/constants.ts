export const SITE = {
  name: "Impjieg",
  title: "Impjieg — Malta’s modern jobs marketplace",
  tagline: "Tech, digital, and iGaming jobs in Malta.",
  description:
    "Find tech, digital, and iGaming jobs in Malta with clear filters, work-mode signals, and faster apply paths.",
