...
- [ ] Commit `.env.example` so the documented env contract matches production
...
- [ ] Strengthen distribution beyond on-site discovery
  - Add employer-facing email amplification.
  - Add social promotion workflow.
  - Add Google indexing discipline for fresh/expired jobs.
...
- [~] Build trust signals
  ...
  - [ ] Verified response times, employer activity, listing quality checks.
